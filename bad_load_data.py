...
while (time.time() < end):
    if (time.time() - last > 1):
        ...
        for row in c.execute("SELECT * FROM Plants WHERE Name = 'PlantZero'"):
            plant = row[0]
        system = -1
        for row in c.execute("SELECT * FROM Systems WHERE Type = 'Turbine' AND PlantId = " + str(plant)):
            system = row[0]
        sensor = -1
        for row in c.execute("SELECT * FROM Sensors WHERE Type = 'Humidity' AND SystemId = " + str(system)):
            sensor = row[0]
        ...
        for row in c.execute("SELECT * FROM Systems WHERE Type = 'Turbine' AND PlantId = " + str(plant)):
            system = row[0]
        for row in c.execute("SELECT * FROM Sensors WHERE Type = 'Temperature' AND SystemId = " + str(system)):
            sensor = row[0]
        ...
        for row in c.execute("SELECT * FROM Systems WHERE Type = 'Turbine' AND PlantId = " + str(plant)):
            system = row[0]
        for row in c.execute("SELECT * FROM Sensors WHERE Type = 'Pressure' AND SystemId = " + str(system)):
            sensor = row[0]
        ...
        for row in c.execute("SELECT * FROM Plants WHERE Name = 'PlantZero'"):
            plant = row[0]
        for row in c.execute("SELECT * FROM Systems WHERE Type = 'Teslacoil' AND PlantId = " + str(plant)):
            system = row[0]
        for row in c.execute("SELECT * FROM Sensors WHERE Type = 'Humidity' AND SystemId = " + str(system)):
            sensor = row[0]
        ...
        for row in c.execute("SELECT * FROM Plants WHERE Name = 'PlantZero'"):
            plant = row[0]
        for row in c.execute("SELECT * FROM Systems WHERE Type = 'Fluxcapacitor' AND PlantId = " + str(plant)):
            system = row[0]
        for row in c.execute("SELECT * FROM Sensors WHERE Type = 'Humidity' AND SystemId = " + str(system)):
            sensor = row[0]
        ...
        for row in c.execute("SELECT * FROM Plants WHERE Name = 'PlantOne'"):
            plant = row[0]
        for row in c.execute("SELECT * FROM Systems WHERE Type = 'Turbine' AND PlantId = " + str(plant)):
            system = row[0]
        for row in c.execute("SELECT * FROM Sensors WHERE Type = 'Humidity' AND SystemId = " + str(system)):
        ...
        for row in c.execute("SELECT * FROM Plants WHERE Name = 'PlantTwo'"):
            plant = row[0]
        for row in c.execute("SELECT * FROM Systems WHERE Type = 'Turbine' AND PlantId = " + str(plant)):
            system = row[0]
        for row in c.execute("SELECT * FROM Sensors WHERE Type = 'Humidity' AND SystemId = " + str(system)):
        ...
        for row in c.execute("SELECT * FROM Plants WHERE Name = 'PlantThree'"):
            plant = row[0]
        for row in c.execute("SELECT * FROM Systems WHERE Type = 'Turbine' AND PlantId = " + str(plant)):
            system = row[0]
        for row in c.execute("SELECT * FROM Sensors WHERE Type = 'Humidity' AND SystemId = " + str(system)):
        ...
        for row in c.execute("SELECT * FROM Plants WHERE Name = 'PlantFour'"):
            plant = row[0]
        for row in c.execute("SELECT * FROM Systems WHERE Type = 'Turbine' AND PlantId = " + str(plant)):
            system = row[0]
        for row in c.execute("SELECT * FROM Sensors WHERE Type = 'Humidity' AND SystemId = " + str(system)):
